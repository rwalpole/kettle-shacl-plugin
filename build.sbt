...
libraryDependencies += "pentaho-kettle"    % "kettle-ui-swt"         % pentahoVersion
libraryDependencies += "pentaho"           % "pentaho-metaverse-api" % pentahoVersion
libraryDependencies += "pentaho"           % "metastore"             % pentahoVersion
...
libraryDependencies += "org.mockito"       % "mockito-core"          % "3.11.0" % "test"
